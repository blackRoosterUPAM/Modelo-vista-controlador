...
CREATE TABLE `alumnodocs` (
  ...
  CONSTRAINT `alumnodocs_ibfk_1` FOREIGN KEY (`Matricula`) REFERENCES `alumnos` (`Matricula`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `alumnosede` (
  ...
  KEY `Matricula` (`Matricula`),
  KEY `IdSede` (`IdSede`),
  CONSTRAINT `alumnosede_ibfk_1` FOREIGN KEY (`Matricula`) REFERENCES `alumnos` (`Matricula`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `alumnosede_ibfk_2` FOREIGN KEY (`IdSede`) REFERENCES `sede` (`IdSede`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `codigos_recuperacion` VALUES (5615,'771193'),(23456789,'433472');
...
CREATE TABLE `docalumnoperiodo` (
  ...
  KEY `IdPeriodo` (`IdPeriodo`),
  CONSTRAINT `docalumnoperiodo_ibfk_1` FOREIGN KEY (`Matricula`) REFERENCES `alumnos` (`Matricula`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `periodo` VALUES (1,'Septiembre-Diciembre',2023,1),(2,'Enero-Abril',2023,1),(3,'Enero-Abril',2024,1),(4,'Enero-Abril',2024,0),(5,'Mayo-Agosto',2024,1);
...
CREATE TABLE `pliberación` (
  ...
  KEY `IdProceso` (`IdProceso`),
  CONSTRAINT `pliberación_ibfk_1` FOREIGN KEY (`Matricula`) REFERENCES `alumnos` (`Matricula`) ON DELETE CASCADE ON UPDATE CASCADE,
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ptc` (
  `idPtc` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `ptc` VALUES (214,'raul','raul','raul','raul@gmail.com',3),(1150,'Luis Benito','Vargas','García','luis.vargas@upamozoc.edu.mx',2);
...
CREATE TABLE `sede` (
  ...
  `CorreoContacto` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `Telefono` bigint NOT NULL,
...
INSERT INTO `sede` VALUES (1234,'GenSoft','Cd modelo puebla','lsc.luisvargas@gmail.com',2215982344,'Privada',''),(5615,'Prueba','Prueba','b.rodriguezt@upam.ed.mx',2216171616,'Privada',''),(456511,'Kautilab','fafafa','kautilab@gmail.com',2212122122,'Publica',''),(21032026,'aerobot','san patrcio ','aerobot@gmail.com',1231231111,'Publica','');
...
INSERT INTO `usuarios` VALUES (10,'g@g.g','202cb962ac59075b964b07152d234b70',8,'Graphics','G','G'),(214,'raul@gmail.com','202cb962ac59075b964b07152d234b70',7,'Luis Raúl ','Antonio','Antonio'),(1150,'luis.vargas@upamozoc.edu.mx','827ccb0eea8a706c4c34a16891f84e7b',7,'Luis Benito','Vargas','García'),(1234,'lsc.luisvargas@gmail.com','b6366d345f26a0ba5b155423ba4e72a2',5,'Michel','Vargas ','Hernández'),(5615,'b.rodriguezt@upam.ed.mx','81dc9bdb52d04dc20036dbd8313ed055',5,'Prueba','Prueba','Prueba'),(9001,'vinculacion@upamozoc.edu.mx','6ebe76c9fb411be97b3b0d48b791a7c9',3,'Vinculacion','Vinculacion','Viculacion'),(9002,'superadmin@upamozoc.edu.mx','6ebe76c9fb411be97b3b0d48b791a7c9',1,'Super','Admin','istrador'),(9003,'director@upamozoc.edu.mx','6ebe76c9fb411be97b3b0d48b791a7c9',6,'Director','Director','Director'),(9004,'escolares@upamozoc.edu.mx','6ebe76c9fb411be97b3b0d48b791a7c9',2,'servicios','escolares','escolares'),(21032026,'aerobot@gmail.com','81dc9bdb52d04dc20036dbd8313ed055',5,'diego','hernandez','juarez');
...
-- Dump completed on 2024-01-31  3:12:50
