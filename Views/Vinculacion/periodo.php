                                ...
                                <script>
                                    ...
                                    $('#buscarDatos').click(function() {
                                        ...
                                        if (searchText !== '') {
                                            ...
                                            $.ajax({
                                                url: "index.php?c=periodo&a=mostrar_busqueda", // Reemplaza 'buscar_alumnos.php' con la ruta correcta a tu archivo PHP que realiza la búsqueda
                                                method: 'POST',
                                                data: {
                                                    busqueda: searchText
                                                },
                                            ...
                                            Swal.fire({
                                                ...
                                                window.location.href = 'index.php?c=periodo&a=show_periodos';
                                            });
                                        }
                                    });
                                </script>
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            ...
                            <script>
                                $(document).ready(function() {
                                    $('#kt_new_periodo_form').submit(function(event) {
